...
User.create!(coach: 'true', avatar: Faker::Avatar.image, name: 'Coach Fredrickson', city: 'Austin', team: Faker::Team.name, bio: Faker::Hacker.say_something_smart, phone: Faker::PhoneNumber.phone_number, email: 'coach7@example.com', password: 'password', sports: 'Volleyball, Tennis', zip_code: '78713')
